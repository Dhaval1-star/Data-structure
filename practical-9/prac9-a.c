// practical 9a: Hashing (Linear Probing)
#include<stdio.h>
#include<limits.h>
#include<malloc.h>
/* This is code for linear probing in open addressing. If you want to do quadratic probing and double hashing which are also open addressing methods in this code used hash function that (pos+1)%hFn in that place just replace with another function.*/
...
void deleteitem(int ary[],int hFn,int size){
    /*
